	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http
				...
				.authorizeHttpRequests(auth -> auth
						...
						.requestMatchers(HttpMethod.POST, "/api/grades").hasAnyRole("ADMINISTRATION", "TEACHER")
						...
						.requestMatchers(HttpMethod.POST, "/api/absences").hasAnyRole("ADMINISTRATION", "TEACHER")
